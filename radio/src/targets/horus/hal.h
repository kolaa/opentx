...
// Serial Port (DEBUG)
#if !defined(EXTERNAL_MODULE_PXX2) && defined(PCBX12S) || defined(RADIO_TX16S)
...
#if defined(RADIO_TX16S) && !defined(EXTERNAL_MODULE_PXX2)
...
#if !defined(EXTERNAL_MODULE_PXX2) && defined(PCBX10) || PCBREV >= 13
...
#if defined(RADIO_TX16S) && defined(EXTERNAL_MODULE_PXX2) || (defined(PCBX10) && defined(PCBREV_EXPRESS))
...
#if defined(PXX2) && !defined(RADIO_TX16S)
